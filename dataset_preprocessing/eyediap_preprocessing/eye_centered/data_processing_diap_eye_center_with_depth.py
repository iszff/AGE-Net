...
import eyecenter_data_processing_core as dpc


root = "/data/EYEDIAP/EYEDIAP/Data"
out_root = "/data/Eyediap_eye_center_depth_all"
scale =False
...
#        exit()
        ...
        norm = dpc.norm(left_center = left3d,
                        right_center = right3d,
                        center = face3d,
                        gazetarget = target3d,
                        headrotvec = head_rot,
                        imsize = (224, 224),
        ...
        left_gaze = norm.Get_left_Gaze(scale=scale)
        right_gaze = norm.Get_right_Gaze(scale=scale)
        ...
        left_gaze2d = dpc.GazeTo2d(left_gaze)
        right_gaze2d = dpc.GazeTo2d(right_gaze)
    ...
    #    im_right = dpc.EqualizeHist(im_right)
        ...
        save_left_gaze2d = ",".join(left_gaze2d.astype("str"))
        save_right_gaze2d = ",".join(right_gaze2d.astype("str"))
        ...
        save_str = " ".join([save_name_face, save_name_left, save_name_right, save_name_face_depth, save_name_left_depth, save_name_right_depth, save_metapath, save_left_gaze, save_right_gaze,save_head, save_left_gaze2d,save_right_gaze2d , save_head2d, save_rvec, save_svec, save_origin]) 

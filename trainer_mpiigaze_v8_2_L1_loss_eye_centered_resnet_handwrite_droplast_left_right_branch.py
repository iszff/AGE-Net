...
import fire
import numpy as np
from data import read_mpiiface_eyecenter
...
class GazeTrainer(Trainer):
    def __init__(self,
        ...
        self.eyediap_image_path = '/data/Eyecenter_MPIIFaceGaze_224_not_flip/Image'
    ...
    def _get_eyediap_trainloader(self):
        ...
        train_loader = read_mpiiface_eyecenter.txtload(trainlabelpath, imagepath, self.batch_size_train,
    ...
    def _get_eyediap_valloader(self):
        ...
        test_loader = read_mpiiface_eyecenter.txtload(testlabelpath, imagepath, self.batch_size_train,
                                                      shuffle=True, num_workers=self.num_workers, header=True)
        return test_loader

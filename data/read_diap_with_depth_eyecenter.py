...
class loader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        ##face, left, right,face_depth,left_depth,right_depth,metapath,left_gaze,right_gaze,head, left_gaze2d,right_gaze2d , head2d,rvec,svec,origin
        face = line[0]
        lefteye = line[1]
        righteye = line[2]
        face_depth = line[3]

...
from data import read_mpiiface
import json
...
class GazeTrainer(Trainer):
    def __init__(self,
        ...
        self.eyediap_image_path = '/data/Facecenter_MPIIFaceGaze_224_not_flip/Image'
        self.eyediap_label_path = '/data/Facecenter_MPIIFaceGaze_224_not_flip/Label'
    ...
    def _get_eyediap_trainloader(self):
        ...
        train_loader = read_mpiiface.txtload(trainlabelpath, imagepath, self.batch_size_train,
    ...
    def _get_eyediap_valloader(self):
        ...
        test_loader = read_mpiiface.txtload(testlabelpath, imagepath, self.batch_size_val,
                                            shuffle=True, num_workers=self.num_workers, header=True)
        return test_loader
